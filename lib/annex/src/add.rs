...
impl Annex {
    ...
    ///
    /// See `add_opt`
    pub fn add(&self, files: impl Stream<Item=String>) 
        -> (impl Future<Output=Result<(), io::Error>>, Result<impl Stream<Item=AddResult>, std::io::Error>)
    {
        self.add_opt(files, false, false, false)
    }
    ...
    pub fn add_opt(&self, files: impl Stream<Item=String>, include_dotfiles: bool, force: bool, update: bool) 
        -> (impl Future<Output=Result<(), io::Error>>, Result<impl Stream<Item=AddResult>, std::io::Error>)
    {
